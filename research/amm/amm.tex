...
\input{derivations/buy-with-fee/base-volume.tex}
\input{derivations/buy-with-fee/base-out.tex}
\input{derivations/buy-with-fee/marginal-price.tex}
\input{derivations/buy-with-fee/slippage-price.tex}
\input{derivations/buy-with-fee/slippage-input.tex}
\input{derivations/buy-with-fee/quadratic-inequality.tex}
