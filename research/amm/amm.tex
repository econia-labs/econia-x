...
$b_{out}$ is a function of $b_i$, fee rate $f$, $q_i$, and
$q_{in}$, per Equation~\ref{eqn:swap-buy-with-fee-base-out}.

\begin{equation}\label{eqn:swap-buy-with-fee-base-out}
	b_{out} (b_i, f, q_i, q_{in}) = (1 - f) \cdot \frac{b_i \cdot q_{in}}{q_i + q_{in}}
\end{equation}

As derived in
Section~\ref{sssec:equation-eqn-swap-buy-with-fee-base-final-derivation},
$b_f (b_i, f, q_i, q_{in})$ is given in Equation~\ref{eqn:swap-buy-with-fee-base-final}.

\begin{equation}\label{eqn:swap-buy-with-fee-base-final}
	b_f (b_i, f, q_i, q_{in}) =
	b_i \cdot \frac{q_i + f \cdot q_{in}}{q_i + q_{in}}
\end{equation}

As derived in
Section~\ref{sssec:equation-eqn-swap-buy-with-fee-taker-execution-price-derivation},
$p_t (b_i, f, q_i, q_{in})$ is given in
...
\begin{equation}\label{eqn:swap-buy-with-fee-marginal-price}
	p_m (b_i, f, q_i) = \frac{q_i}{(1 - f) \cdot b_i}
\end{equation}
...
As derived in Section~\ref{sssec:equation-eqn-swap-buy-with-fee-converge-derivation},
see Equation~\ref{eqn:swap-buy-with-fee-convergence}.
...
\input{derivations/swap-buy-with-fee/base-final.tex}
\input{derivations/swap-buy-with-fee/taker-execution-price.tex}
