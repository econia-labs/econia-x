...
\begin{equation}\label{eqn:swap-buy-with-fee-slippage-price}
	p_s (b_i, f, q_i, q_{in}) = \frac{q_i + q_{in}}{f^{\dagger} \cdot
...
roots for $p_s > p_m$, one positive and one negative.

The derivative of $F$ with respect to $q_s$, $F'(q_s)$, is given in
