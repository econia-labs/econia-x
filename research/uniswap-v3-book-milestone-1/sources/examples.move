module research::examples {
    ...
    fun first_swap() {
        ...
        let delta_sqrt_p =
            math::divide_q64_unchecked(math::u64_to_q64(quote_amount), liquidity);
        ...
        let delta_base =
            math::q64_to_u64(
                math::subtract_q64_unchecked(
                    math::divide_q64_unchecked(liquidity, sqrt_p_c),
                    math::divide_q64_unchecked(liquidity, target_sqrt_p)
                )
            );
